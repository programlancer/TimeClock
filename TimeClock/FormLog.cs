...
namespace Programlancer
{
    public partial class FormLog : Form
    {
        ...
        public FormLog(User activeUser)
        {
            this.activeUser = activeUser;

            InitializeComponent();

            this.dataGridViewLog.Columns[0].HeaderText = Program.resourceManager.GetString("strId");
            this.dataGridViewLog.Columns[1].HeaderText = Program.resourceManager.GetString("strLogin");
            this.dataGridViewLog.Columns[2].HeaderText = Program.resourceManager.GetString("strWhen");
            this.dataGridViewLog.Columns[3].HeaderText = Program.resourceManager.GetString("strWhat");
        }
